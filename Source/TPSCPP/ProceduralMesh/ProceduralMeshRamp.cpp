...
#include "ProceduralMeshRamp.h"

void AProceduralMeshRamp::GenerateMesh()
{
	// Define vertices.
	...
	Triangles.Add(0); Triangles.Add(1); Triangles.Add(2); Triangles.Add(0); Triangles.Add(2); Triangles.Add(3); // Ramp quad.
	Triangles.Add(5); Triangles.Add(2); Triangles.Add(1); Triangles.Add(5); Triangles.Add(1); Triangles.Add(4); // Back quad.
	Triangles.Add(3); Triangles.Add(5); Triangles.Add(4); Triangles.Add(3); Triangles.Add(4); Triangles.Add(0); // Front quad.
	Triangles.Add(4); Triangles.Add(1); Triangles.Add(0); // Right triangle.
	Triangles.Add(3); Triangles.Add(2); Triangles.Add(5); // Left triangle
