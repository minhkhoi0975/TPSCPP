...
#include "ProceduralMeshSkewedCube.h"

void AProceduralMeshSkewedCube::GenerateMesh()
{
	// Fix the size.
	...
	UniqueVertices.Add(FVector(Size.X, 0.0f, DeltaZ.Z));
	UniqueVertices.Add(FVector(Size.X, Size.Y, DeltaZ.Z));
	UniqueVertices.Add(FVector(0.0f, Size.Y, 0.0f));
	UniqueVertices.Add(FVector(0.0f, 0.0f, Size.Z-DeltaZ.Z));
	UniqueVertices.Add(FVector(Size.X, 0.0f, Size.Z));
	UniqueVertices.Add(FVector(Size.X, Size.Y, Size.Z));
	UniqueVertices.Add(FVector(0.0f, Size.Y, Size.Z - DeltaZ.Z));
